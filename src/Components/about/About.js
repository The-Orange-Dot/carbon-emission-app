  ...
  return (
    <div className="about-container">
      <div className="about-card">
        ...
        <br />
        <p>
          [insert-app-name] was created to give users a fun and easy way to get
          a snapshot of their personal carbon footprint. The app takes a look at
          some of the most common carbon emitting activities and provides user
          the ability to fill in their personal details and receive an estimate
          of carbon emissions based on data provided by the{" "}
          <strong>Carbon Interface REST API</strong>. The data that powers the
          API is sourced from governments, non-profits, and leading researchers
          around the world including the <strong>EPA</strong>,{" "}
          <strong>GHG Protocol</strong>, and <strong>Environment Canada</strong>
          . The app is designed to create awareness by powering carbon
          measurement to combat climate change.
        </p>
      </div>
      <div className="">
